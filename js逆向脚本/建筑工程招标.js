...
function Md5(e) {
    ...
    HEX_CHARS = "0123456789abcdef".split(""), EXTRA = [128, 32768, 8388608, -2147483648], SHIFT = [0, 8, 16, 24], OUTPUT_TYPES = ["hex", "array", "digest", "buffer", "arrayBuffer", "base64"], BASE64_ENCODE_CHAR = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split("")
    if (e)
...
Md5.prototype.update = function (e) {
    if (!this.finalized) {
        ...
        if ("string" !== n) {
            ...
            if (null === e)
                throw ERROR;
            if (true && e.constructor === ArrayBuffer)
                e = new Uint8Array(e);
            else if (!(Array.isArray(e) || true && ArrayBuffer.isView(e)))
                throw ERROR;
            t = !0
        }
